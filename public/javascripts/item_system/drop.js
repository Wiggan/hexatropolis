...
function drop_mana(dropper) {
    var mana;
    if (dropper.level < 10) {
        mana = mana_small(dropper.x, dropper.y);
    } else if (dropper.level < 20) {
        mana = mana_medium(dropper.x, dropper.y);
    } else {
        mana = mana_large(dropper.x, dropper.y);
    }
